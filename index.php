				...
				<thead>
						...
						<td colspan=2 class=triple-padded-desktop><?php
							...
							<form action="" method=post>
								<fieldset class="double-padded-desktop square" id=fieldset>
									<legend accesskey=a class=center>
									...
									<textarea class="dark square" name=schedule id=schedule accesskey=s tabindex=0 required<?php
										switch($color)
										{
											case 'none' : echo ' style="color:#dbdbdc;background-color:#3b3b3b"'; break;
											case 'white' : echo ' style="color:black;background-color:white"'; break;
											case 'blue' : echo ' style="color:#337ab7;background-color:#d9edf7"'; break;
											case 'green' : echo ' style="color:#3c763d;background-color:#dff0d8"'; break;
											case 'yellow' : echo ' style="color:#8a6d3b;background-color:#fcf8e3"'; break;
											case 'pink' : echo ' style="color:#a94442;background-color:#f2dede"'; break;
										}
										echo $schedule ? '>'. trim($schedule) : ' placeholder="'. $placeholder. 'の予定">'
									?></textarea>
					...
					<tr>
						<th colspan=2 class=align-center id=nav>
							<span class=gapped><a href="./?date=<?=$last_year->format('Y-m')?>#nav"><i class=icon-double-angle-left></i></a></span>
							<span class=gapped><a href="./?date=<?=$last_month->format('Y-m')?>#nav"><i class=icon-angle-left></i></a></span>
							<span class=gapped><a href="./" rel=home></a></span>
							<span class=gapped><a href="./?date=<?=$next_month->format('Y-m')?>#nav"><i class=icon-angle-right></i></a></span>
							<span class=gapped><a href="./?date=<?=$next_year->format('Y')?>#nav"><i class=icon-double-angle-right></i></a></span>
						</th>
					</tr>
				</thead>
				<tfoot>
					<tr>
						<th colspan=2 class="align-right white quicksand"><a class=small href="./">© <?=$y?> GH Bullet Journal.</a></th>
					</tr>
				</tfoot>
				<tbody>
					<tr>
								...
								<tbody>
									<tr>
										<td';
												switch($color)
												{
													case 'none' : echo ' class="dark box schedule square"'; break;
													case 'white' : echo ' class="white box schedule square"'; break;
													case 'blue' : echo ' class="info box schedule square"'; break;
													case 'green' : echo ' class="success box schedule square"'; break;
													case 'yellow' : echo ' class="alert box schedule square"'; break;
													case 'pink' : echo ' class="error box schedule square"'; break;
												}
									echo '>', (trim($complete) === 'complete' ? '<del>'. $schedule. '</del>' : $schedule), '</td>';
